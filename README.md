...
[![Twitter Follow](https://img.shields.io/twitter/follow/Adnan__Bhaldar_?style=social)](https://twitter.com/intent/follow?screen_name=Adnan__Bhaldar)
  ...
  <a href="https://adnan-bhaldar.github.io/Booken/"><strong>➥ Live Demo</strong></a>
...
```bash
sudo git clone https://github.com/adnan-bhaldar/booken.git
```

Windows:

```bash
git clone https://github.com/adnan-bhaldar/booken.git
```
